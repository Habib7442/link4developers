  ...
  return (
    <div className="min-h-screen relative" style={getBackgroundStyle()}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 relative z-10">
        ...
        {/* Profile Header */}
        <div className="bg-[#1A1A1A] border border-[#00F5FF]/30 rounded-2xl p-5 mb-6 relative overflow-hidden" 
              ...
              {user.avatar_url && user.avatar_url.trim() !== '' ? (
                <div className="relative">
                  <Image
                    ...
                    width={80}
                    height={80}
                    className="w-[80px] h-[80px] rounded-full object-cover border-2 border-[#00F5FF]"
                  />
                ...
                <div className="w-[80px] h-[80px] rounded-full bg-gradient-to-r from-[#00F5FF] to-[#FF00FF] flex items-center justify-center border-2 border-[#00F5FF]"
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-[12px] mb-3"
                    ...
                    {user.company && (
                      <div className="flex items-center gap-1">
                        <Building className="w-3.5 h-3.5 text-[#00F5FF]" />
                ...
                <Button
                  onClick={handleShare}
                  className="bg-gradient-to-r from-[#00F5FF] to-[#FF00FF] hover:from-[#FF00FF] hover:to-[#00F5FF] text-white border-0 px-5 py-2.5 rounded-xl font-bold text-[14px] relative overflow-hidden group font-orbitron"
        ...
        {hasLinks ? (
          <div className="space-y-5">
            {categoryOrder.map((category) => {
              ...
              return (
                ...
                >
                  {/* Category Header */}
                  <div className="bg-gradient-to-r from-[#00F5FF]/10 to-[#FF00FF]/10 border-b border-[#00F5FF]/30 px-5 py-3 relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#00F5FF]/5 to-[#FF00FF]/5"></div>
                    <div className="relative z-10 flex items-center gap-2.5">
                      <div className="p-1.5 rounded-lg bg-[#00F5FF]/20 border border-[#00F5FF]/30"
                           style={{ boxShadow: '0 0 10px rgba(0, 245, 255, 0.3)' }}>
                        {(() => {
                          // For projects category, always show GitHub icon
                          if (category === 'projects') {
                            return <Github className="w-4 h-4 text-[#00F5FF]" />
                          }
                          
                          // For blogs category, always show BookOpen icon
                          if (category === 'blogs') {
                            return <BookOpen className="w-4 h-4 text-[#00F5FF]" />
                          }
                          
                          // For other categories, use the mapped icon
                          const IconComponent = CategoryIcon
                          if (IconComponent && typeof IconComponent === 'function') {
                            return <IconComponent className="w-4 h-4 text-[#00F5FF]" />
                          }
                          
                          // Fallback
                          return <ExternalLink className="w-4 h-4 text-[#00F5FF]" />
                        })()}
                      </div>
                      <h2 className="text-[18px] font-bold leading-[1.3] font-orbitron text-[#00F5FF]"
                          style={{ textShadow: '0 0 8px rgba(0, 245, 255, 0.6)' }}>
                        {category.charAt(0).toUpperCase() + category.slice(1)}
                      </h2>
                      <span className="text-[12px] text-[#39FF14] font-inter font-medium"
          ...
          <div className="bg-[#1A1A1A] border border-[#00F5FF]/30 rounded-2xl p-6 text-center relative overflow-hidden"
               style={{ boxShadow: '0 0 15px rgba(0, 245, 255, 0.2), 0 0 30px rgba(0, 245, 255, 0.1)' }}>
            <div className="absolute inset-0 bg-gradient-to-r from-[#00F5FF]/5 to-[#FF00FF]/5"></div>
            <div className="relative z-10">
              <h2 className="text-[20px] font-bold leading-[1.3] mb-2 font-orbitron text-[#00F5FF]"
        ...
        {!user.is_premium && !isPreview && (
          <div className="mt-6 text-center">
            <div className="bg-[#1A1A1A] border border-[#00F5FF]/30 rounded-xl p-3 inline-block relative overflow-hidden"
